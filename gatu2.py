...
command = 'timidity -Ow -A120 -EFreverb=0.8 -EFchorus=0.8,0.7,130 -EFflanger=0.8,0.65,0.5 lux.mid -o - | ffmpeg -i - -acodec libmp3lame -ab 64k lux_ghostly.mp3'
# ~ command = 'timidity -Ow -A120 -EFreverb=0.8 -EFchorus=0.8,0.7,130 -EFflanger=0.8,0.65,0.5 lux.mid -o - | ffmpeg -i - -af "volume=19dB" -acodec libmp3lame -ab 64k lux_ghostly.mp3'
os.system(command)
